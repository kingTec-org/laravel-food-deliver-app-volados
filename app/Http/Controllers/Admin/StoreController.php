	...
	public function all_stores() {
		...
		$datatable = DataTables::of($stores)
			...
			->addColumn('action', function ($stores) {
				return '<a title="' . trans('admin_messages.edit_preparation_time') . '" href="' . route('admin.edit_preparation_time', $stores->id) . '" ><i class="material-icons notranslate">alarm_add</i></a>&nbsp;<a title="' . trans('admin_messages.menu_category') . '" href="' . route('admin.menu_category', $stores->id) . '" ><i class="material-icons notranslate">category</i></a>&nbsp;<a title="' . trans('admin_messages.edit_open_time') . '" href="' . route('admin.edit_open_time', $stores->id) . '" ><i class="material-icons notranslate">alarm_on</i></a>&nbsp;<a title="' . trans('admin_messages.edit') . '" href="' . route('admin.edit_store', $stores->id) . '" ><i class="material-icons notranslate">edit</i></a>&nbsp;<a title="' . trans('admin_messages.delete') . '" href="javascript:void(0)" class="confirm-delete" data-href="' . route('admin.delete_store', $stores->id) . '"><i class="material-icons notranslate">close</i></a>';
			})
