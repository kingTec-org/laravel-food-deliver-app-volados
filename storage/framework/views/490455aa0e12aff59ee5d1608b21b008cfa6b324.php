<?php if((Route::current()->uri() == 'driver/signup' || Route::current()->uri() == 'driver') & Route::current()->uri() !== 'login' & Route::current()->uri() !== 'driver/password'): ?>
<header class="driver driver-header">
	<div class="container">
		<div class="d-flex align-items-center justify-content-between">
			<div class="logo">
				<a href="<?php echo e(route('driver.home')); ?>">
					<img class="d-none d-md-inline-block" src="<?php echo e(site_setting('1','7')); ?>">
					<img class="d-inline-block d-md-none" src="<?php echo e(site_setting('1','8')); ?>">
				</a>
			</div>
			...
			<a class="nav-link btn btn-primary" href="<?php echo e(route('driver.login')); ?>"><?php echo e(trans('messages.profile.sign_in')); ?></a>
		</div>
	</div>
</header>
<?php endif; ?>

<?php if(Route::current()->uri() == 'driver/login' || Route::current()->uri() == 'driver/login_session' || Route::current()->uri() == 'driver/password'): ?>
		...
		<div class="driver-info-head clearfix">
			<div class="logo d-flex justify-content-center align-items-center">
				<a href="<?php echo e(route('driver.profile')); ?>">
					<img src="<?php echo e(site_setting('1','8')); ?>">
				</a>
			</div>
						...
						<li class="nav-item dropdown">
							<a class="nav-link d-inline-block align-middle user-name p-0 dropdown-toggle" data-toggle="dropdown" href="#">
								<i class="d-inline-block user-icon mr-1">
									<?php if(@Auth::guard('driver') == ''): ?>
									<img src="<?php echo e(url('/')); ?>/images/user.png" class="profile_picture"/>
									<?php else: ?>
									<img src="<?php echo e(@Auth::guard('driver')->user()->driver->driver_profile_picture); ?>" class="profile_picture"/>
									<?php endif; ?>
								</i>
								<?php if(@Auth::guard('driver') != ''): ?>
								<?php echo e(@Auth::guard('driver')->user()->user_first_name); ?> <?php echo e(@Auth::guard('driver')->user()->user_last_name); ?>
							...
							<div class="dropdown-menu">
								<ul class="navbar-nav mr-auto">
									<li class="nav-item">
										<a class="nav-link" href="<?php echo e(route('driver.profile')); ?>">
									...
									<li class="nav-item">
										<a class="nav-link" href="<?php echo e(route('driver.payment')); ?>">
											<i class="icon icon-credit-card"></i>
											<?php echo e(trans('messages.profile.earnings')); ?>

										</a>
									</li>
									<!-- <li class="nav-item">
										<a class="nav-link" href="<?php echo e(route('driver.invoice')); ?>">
											<i class="icon icon-document"></i>
											Invoice
										</a>
									</li> -->
									<li class="nav-item">
										<a class="nav-link" href="<?php echo e(route('driver.trips')); ?>">
											<i class="icon icon-trip"></i>
											<?php echo e(trans('messages.profile.my_trips')); ?>

										</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" href="<?php echo e(route('driver.logout')); ?>">
