...
<main id="site-content" role="main" ng-controller="menu_editor">
	<div class="partners">
		...
		<div class="menu-editor mt-md-4 mb-5" >
			<h1><?php echo e(trans('messages.store.menu_editor')); ?></h1>
			<div class="mt-4 mb-5 panel-content add_loading">
				<div class="d-md-flex align-items-center justify-content-between">
					<h2><?php echo e(trans('messages.store.craft_your_menu')); ?></h2>
					<!-- <p class="required-b">Pending changes</p> -->
				</div>
				<div class="menu-container row m-0 mt-4" ng-init="menu=<?php echo e($menu); ?>; category_index = null; menu_index = null;menu_item_index = null; menu_item_details = {};">
					<div class="col-md-6 col-lg-3 d-md-flex align-items-end flex-column p-0">
						<ul class="menu-list">
							<li ng-repeat="menulist in menu" ng-init="initToggleBar()" ng-class="menu_index == $index ? 'open active' : '' " >
								...
								<div id="tooltip_id-{{ menulist.id}}" class="tooltip-link">
									...
									<div class="tooltip-content">
										<a href="javascript:void(0)" data-toggle="modal" data-target="#edit_menu_modal" ng-click="menu_time($index,menulist.menu_id,menulist.menu)" class="clearfix">
											...
											<?php echo e(trans('admin_messages.edit')); ?>
										...
										<a href="javascript:void(0)" data-toggle="modal" data-target="#delete_modal" class="category_delete" ng-click="set($index,'menu')">
											...
											<?php echo e(trans('admin_messages.delete')); ?>
								...
								<?php echo e(trans('admin_messages.add_category')); ?>
				...
				<div class="w-100 mt-auto pt-4">
					<button type="button" data-target="#edit_menu_modal"   data-toggle="modal" class="theme-color text-uppercase bg-white text-center w-100" ng-click="add_menu_pop()" ><?php echo e(trans('messages.store_dashboard.add_menu')); ?></button>
				</div>
			</div>
						...
						<div ng-repeat="menucategory in menulist.menu_category"> -->
							...
							<div class="col-md-6 col-lg-3 d-md-flex align-items-end flex-column p-0 mt-5 mt-md-0" ng-show="category_index !== null">
								...
								<div class="w-100 mt-auto pt-4 text-md-right text-lg-left">
									<button type="button" class="theme-color bg-white text-center text-uppercase w-100" ng-click="add_new_item()"><?php echo e(trans('admin_messages.add_item')); ?></button>
								</div>
							</div>
							...
							<div class="item_all_details col-md-12 col-lg-6 d-md-flex align-items-end flex-column p-0 mt-5 mt-lg-0" ng-show="menu_item_index !== null">
								<div class="panel-content w-100">
									<form id="item_form" class="form_valitate">
										<label><?php echo e(trans('admin_messages.item_name')); ?> <span class="required" aria-required="true">*</span></label>
										...
										<div class="item-info border-0 mt-3">
											<label><?php echo e(trans('messages.store.item_description')); ?> </label>
											<textarea name="menu_item_desc" ng-model="menu_item_details.menu_item_org_desc"> {{menu_item_details.menu_item_desc}}</textarea>
										</div>
										<div class="row my-3">
											<div class="col-md-4">
												<label><?php echo e(trans('admin_messages.price')); ?> <span class="required" aria-required="true">*</span></label>
											...
											<div class="col-md-4 my-3 mt-md-0">
												<label><?php echo e(trans('messages.profile_orders.tax')); ?> %</label>
												<input autocomplete="off" type="text" name="menu_item_tax" ng-model="menu_item_details.menu_item_tax" value="0" placeholder="<?php echo e(trans('messages.profile.percentage')); ?>">
											</div>
											<div class="col-md-4">
												<label><?php echo e(trans('messages.store.item_visibility')); ?> <span class="required" aria-required="true">*</span></label>
												<?php echo Form::select('item_status', ['1'=>trans('admin_messages.active'),'0' =>trans('admin_messages.inactive')], '', ['class' => '','placeholder' =>trans('messages.store_dashboard.select_status'),'ng-model'=>'menu_item_details.menu_item_status']); ?>

											</div>
										</div>
										<!-- <div class="row my-3">
											<div class="col-md-6">
												<label><?php echo e(trans('messages.store.item_type')); ?> <span class="required" aria-required="true">*</span></label>
												<?php echo Form::select('item_type', ['0'=>trans('messages.store_dashboard.veg'),'1' =>trans('messages.store_dashboard.non_veg')], '', ['class' => '','placeholder' => trans('messages.store_dashboard.select_type'),'ng-model'=>'menu_item_details.menu_item_type']); ?>
										...
										<div class="row mt-3">
											<div class="col-md-6">
												<label><?php echo e(trans('messages.store.item_image')); ?>

													<span class="rec-info d-block">
														(<?php echo e(trans('messages.store.recommended')); ?> <?php echo e(trans('admin_messages.size')); ?>: 1350*310)
													</span>
												</label>
												<div class="file-input menu_image">
													...
													<a class="choose_file_type banner_choose" id="chooses_file"><span id="banner_name"><?php echo e(trans('messages.profile.choose_file')); ?></span></a>
										...
										<div class="row mt-3">
											<div class="col-md-12">
												<div class="panel menu_edit_opt" ng-init="menu_item_translations = <?php echo e(json_encode(old('menu_item_translations') ?: array())); ?>; item_remove_translations =  []; errors = <?php echo e(json_encode($errors->getMessages())); ?>;" ng-cloak>
													...
													<div class="panel-body" ng-repeat="translation in menu_item_translations">
														...
														<div class="card" >
															<h4 class="box-title text-center"><?php echo e(trans('messages.translations')); ?></h4>
															...
															<div class="card-body">
																<div class="row" >
																	<label for="input_language_{{$index}}" class="col-sm-4 col-form-label"><?php echo e(trans('messages.language')); ?><em class="text-danger">*</em></label>
																	<div class="col-sm-8">
																		<div class="form-group">
																			<div class="select">
																				<select name="menu_item_translations[{{$index}}][locale]" class="form-control" id="input_language_{{$index}}" ng-model="translation.locale" >
																					<option value='' ng-if="translation.locale == ''"><?php echo e(trans('messages.select_language')); ?></option>
																...
																<div class="row">
																	<label for="input_name_{{$index}}" class="col-sm-4 col-form-label"><?php echo e(trans('messages.name')); ?><em class="required text-danger">*</em></label>
																	<div class="col-sm-8">
																		<div class="form-group">
																			<?php echo Form::text('menu_item_translations[{{$index}}][name]', '{{translation.name}}', ['class' => 'form-control', 'id' => 'input_name_{{$index}}', 'placeholder' =>trans('messages.item_name'),'ng-model' => 'translation.name']); ?>
																...
																<div class="row">
																	<label for="input_content_{{$index}}" class="col-sm-4 col-form-label"><?php echo e(trans('messages.description')); ?><em class="required text-danger">*</em></label>
																	<div class="col-sm-8">
																		<div class="form-group">
																			<?php echo Form::textarea('menu_item_translations[{{$index}}][description]', '{{translation.description}}', ['class' => 'form-control', 'id' => 'input_description_{{$index}}', 'placeholder' => trans('messages.description'),'ng-model' => 'translation.description']); ?>
																...
																<div class="col-sm-12 static_remove p-0 text-right">
																	<button class="btn btn-danger btn-xs" ng-hide="menu_item_translations.length <  <?php echo e(count($language) - 1); ?>" ng-click="menu_item_translations.splice($index, 1); item_remove_translations.push(translation.id)">
																		<?php echo e(trans('messages.remove')); ?>
														...
														<div class="row" ng-show="menu_item_translations.length <  <?php echo e(count(@$language) - 1); ?>">
															<div class="col-sm-12">
																<button type="button" onclick="refreshSelect()" class="btn btn-info" ng-click="menu_item_translations.push({locale:''});" >
																	...
																	<?php echo e(trans('messages.add_translation')); ?>
								...
								<div class="w-100 text-right mt-auto pt-4">
									<button type="button" class="btn btn-theme w-100 text-uppercase" ng-click="update_item()"><?php echo e(trans('admin_messages.submit_changes')); ?></button>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="modal-body item_all_details">
							<form class="form_valitate" id="category_add_form">
								<div class="form-group d-flex menu-name menu_head">
									<input autocomplete="off" class="pl-0" placeholder="<?php echo e(trans('messages.store.category_name')); ?>" type="text" ng-model="category_name"  name="category_name" data-error-placement = "container" data-error-container= "#category-error-box" maxlength = '150' />
									<!-- <i class="icon icon-pencil-edit-button"></i> -->
								</div>
								<span id="category-error-box"></span>
								<div class="panel menu_edit_opt" ng-init="category_translations = <?php echo e(json_encode(old('category_translations') ?: array())); ?>; category_remove_translations =  []; errors = <?php echo e(json_encode($errors->getMessages())); ?>;" ng-cloak>
										...
										<div class="card" >
											...
											<div class="card-body">
												...
												<div class="row">
													...
													<div class="col-sm-8">
														<div class="form-group">
															<?php echo Form::text('category_translations[{{$index}}][name]', '{{translation.name}}', ['class' => 'form-control', 'id' => 'input_name_{{$index}}', 'placeholder' => trans('messages.category_name'),'ng-model' => 'translation.name','maxlength'=> '150']); ?>
								...
								<div class="mt-3 pt-4 modal-footer px-0 border-0 text-right">
									<button data-dismiss="modal" type="cancel" class="btn btn-primary theme-color">
										<?php echo e(trans('messages.store.cancel')); ?>

									</button>
									<button type="submit" class="btn btn-theme ml-2" ng-click="save_category('add')"><?php echo e(trans('messages.store.submit')); ?>
					...
					<div class="modal-content">
						...
						<div class="modal-body item_all_details">
							<form class="form_valitate" id = "category_edit_form">
								<div class="form-group d-flex menu-name menu_head">
									<input autocomplete="off" class="pl-0" placeholder="<?php echo e(trans('messages.store.category_name')); ?>" type="text" ng-model="category_name" name="category_name" ng-value="" data-error-placement = "container" data-error-container= "#category-edit-error-box" maxlength = '150' />
								...
								<div class="mt-3 pt-4 modal-footer px-0 text-right">
									...
									<button type="submit" class="btn btn-theme ml-2" ng-click="save_category('edit')"><?php echo e(trans('messages.store.submit')); ?>
			...
			<div class="modal fade edit_menu_modal " id="edit_menu_modal" role="dialog">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="form-group d-flex menu-name menu_head">
							<input autocomplete="off" class="pl-0" placeholder="<?php echo e(trans('messages.store.menu_name')); ?>" type="text" name="menu_name" ng-model="menu_name" data-error-placement = "container" data-error-container= ".menu_name_error" />
							<!-- <i class="icon icon-pencil-edit-button"></i> -->
						</div>
						...
						<div class="panel menu_edit_opt" ng-init="translations = <?php echo e(json_encode(old('translations') ?: array())); ?>; removed_translations =  []; errors = <?php echo e(json_encode($errors->getMessages())); ?>;" ng-cloak>
								...
								<div class="card">
									...
									<div class="card-body">
										...
										<div class="row">
											...
											<div class="col-sm-8">
												<div class="form-group">
													<?php echo Form::text('translations[{{$index}}][name]', '{{translation.name}}', ['class' => 'form-control', 'id' => 'input_name_{{$index}}', 'placeholder' => trans('messages.menu_name'),'ng-model' => 'translation.name','maxlength'=> '150']); ?>
						...
						<!-- <div class="menu-available" ng-init="menu_timing = '';day_name =<?php echo e(json_encode(day_name())); ?>">
							<p><?php echo e(trans('messages.store.when_is_this_menu_available')); ?></p>
							<div class="d-md-flex menu-view select-day" ng-repeat="available in menu_timing">
								...
								<div class="added-times ml-3 align-items-start">
									<div class="select-time d-flex">
										<div class="select">
											<?php echo Form::select('menu_timing_start_time[]',time_data('time'),'', ['placeholder'=>trans('admin_messages.select'),'data-end_time'=>'{{available.end_time}}','ng-model'=>'available.start_time','id'=>'start-{{$index}}']);; ?>

										</div>
										<span class="m-2"><?php echo e(trans('messages.store.to')); ?></span>
										<div class="select">
											<?php echo Form::select('menu_timing_end_time[]',time_data('time'),'', ['placeholder'=>trans('admin_messages.select'),'ng-model'=>'available.end_time','id'=>'end-{{$index}}']);; ?>
						...
						<div class="mt-3 pt-4 modal-footer px-0 text-right">
							<button data-dismiss="modal" class="btn btn-primary theme-color"><?php echo e(trans('messages.store.cancel')); ?></button>
							<button type="submit" class="btn btn-theme ml-2" ng-click="update_menu_time()"><?php echo e(trans('messages.store.submit')); ?></button>
						</div>
					</form>
				</div>
			</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h3 class="modal-title"><?php echo e(trans('messages.store.delete_this')); ?> <span ng-if="delete_name=='menu'"><?php echo e(trans('messages.store.menu')); ?></span><span ng-if="delete_name=='category'"><?php echo e(trans('messages.store.category')); ?></span><span ng-if="delete_name=='item'"><?php echo e(trans('messages.store.item')); ?></span><?php echo e(trans('messages.store.ques_mark')); ?></h3>
				</div>
				<div class="modal-body">
					<p><?php echo e(trans('messages.store.are_you_sure_to_delete_this')); ?> <span ng-if="delete_name=='menu'"><?php echo e(trans('messages.store.menu')); ?></span><span ng-if="delete_name=='category'"><?php echo e(trans('messages.store.category')); ?></span><span ng-if="delete_name=='item'"><?php echo e(trans('messages.store.item')); ?></span>. <?php echo e(trans('messages.store.this_action_cannot_undone')); ?></p>
					<p class="text-danger delete_item_msg"> </p>
				</div>
				<div class="modal-footer text-right">
					<button type="reset" data-dismiss="modal" class="btn btn-primary theme-color"><?php echo e(trans('messages.store.cancel')); ?></button>
					<button type="submit" class="btn btn-theme ml-2" data-dismiss="modal" ng-click="remove_item(remove_id,delete_name)"><?php echo e(trans('messages.store.submit')); ?></button>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="modal fade" id="delete_error_modal" role="dialog">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer text-right">
					<button data-dismiss="modal" type="reset" class="btn"><?php echo e(trans('messages.store.cancel')); ?></button>
				</div>
			</div>
		</div>
	</div>
