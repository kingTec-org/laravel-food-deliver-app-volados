...
<!--  Google Maps Plugin  -->
<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=<?php echo e(site_setting('google_api_key')); ?>&libraries=places&sensor=false&language=<?php echo e((Session::get('language')) ? Session::get('language') : $default_language[0]->value); ?>"></script>
