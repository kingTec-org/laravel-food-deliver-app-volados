<?php if(Route::current()->uri() == 'driver/signup' & Route::current()->uri() !== 'login'): ?>
			...
			<div class="d-flex flex-wrap justify-content-center">
				<div class="col-12 col-md-4 text-center order-3 order-md-1 mt-4 mt-md-0">
					<div class="select_lang mt-3"> 
						<?php echo Form::select('language',$language, (Session::get('language')) ? Session::get('language') : $default_language[0]->value, ['class' => 'language-selector footer-select selectpicker', 'aria-labelledby' => 'language-selector-label', 'id' => 'driver_language_footer']); ?>
				...
				<div class="col-12 col-md-3 order-1 order-md-2">
					<ul>
						...
						<li>
							<a class="theme-color" href="<?php echo e(route('page',$page_url->url)); ?>">
						...
						<?php endif; ?>
						<li>
							<a class="theme-color" href="<?php echo e(route('help_page',current_page())); ?>">
...
<?php if(Route::current()->uri() == 'driver/login' || Route::current()->uri() == 'driver/login_session' || Route::current()->uri() == 'driver/profile' || Route::current()->uri() == 'driver/payment' || Route::current()->uri() == 'driver/invoice' || Route::current()->uri() == 'driver/trips' || Route::current()->uri() == 'driver/trip_detail' || Route::current()->uri() == 'driver/documents' || Route::current()->uri() == 'driver/daily_payment/{date}'|| Route::current()->uri() == 'driver/detail_payment/{date}'|| Route::current()->uri() == 'driver/vehicle_details' || Route::current()->uri() == 'driver/documents/{id}'): ?>
