                ...
                {!! Form::open(['url' => $form_action, 'class' => 'form-horizontal','id'=>'currency_form']) !!}
                  @csrf
                    <div class="row">
                      ...
                      <div class="col-sm-10">
                        <div class="form-group">
                          {!! Form::text('name',@$currency_select->name, ['class' => 'form-control', 'id' => 'input_name',]) !!}
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-10">
                        <div class="form-group">
                        {!! Form::text('code',@$currency_select->code, ['class' => 'form-control', 'id' => 'input_code',]) !!}
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-10">
                        <div class="form-group">
                        {!! Form::text('symbol',@$currency_select->symbol, ['class' => 'form-control', 'id' => 'input_code',]) !!}
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-10">
                        <div class="form-group">
                        {!! Form::text('rate',@$currency_select->rate, ['class' => 'form-control', 'id' => 'input_code',]) !!}
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-4">
                        <div class="form-group">
                        {!! Form::select('status',['1'=>trans('admin_messages.active'),'0'=>trans('admin_messages.inactive')],@$currency_select->status, ['placeholder' => trans('admin_messages.select'),'class'=>'form-control']); !!}
